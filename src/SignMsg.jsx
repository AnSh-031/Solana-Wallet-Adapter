...
export function SignMessage(){
    ...
    return (
            <div style={{marginTop: "20px",textAlign:"center"}}>
                ...
                <input value={message} onChange={(e) => setMessage(e.target.value)} id="inputEl" type="text" placeholder="Message" style={{padding:"10px",marginTop:"5px",backgroundColor:"#1c1c1c",width:"200px",borderRadius:"8px",border:"1px solid #4f8bff",color:"#ffffff", marginBottom:"10px"}}/>
                <br />
